...
func TestInitCheck(t *testing.T) {
	//
	//TestGetBaiduPacket := "GET / HTTP/1.1\nHost: www.baidu.com\nAccept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7\nAccept-Encoding: gzip, deflate, br\nAccept-Language: zh-CN,zh;q=0.9\nSec-Fetch-Dest: document\nSec-Fetch-Mode: navigate\nSec-Fetch-Site: none\nSec-Fetch-User: ?1\nUpgrade-Insecure-Requests: 1\nUser-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36\nsec-ch-ua: \"Google Chrome\";v=\"119\", \"Chromium\";v=\"119\", \"Not?A_Brand\";v=\"24\"\nsec-ch-ua-mobile: ?0\nsec-ch-ua-platform: \"Windows\""
	//GetBaiduPacket, _ := utils.ParsePacket(TestGetBaiduPacket)
	//spew.Dump(GetBaiduPacket)
	...
	PostBaiduPacket, _ := utils.ParsePacket(TestPostBaiduPacket)
	fmt.Println(request.ParseNewInitRequest(PostBaiduPacket).Status())
}
